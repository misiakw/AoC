...
namespace AoC_2021.Day22
{
    ...
    public class Day22Legacy : ParseableDay<CuboidLegacy>
    {
        public Day22Legacy(string path) : base(path){ }

        public override CuboidLegacy Parse(string input)
        {
            return new CuboidLegacy(input);
        }
    ...
    public class CuboidLegacy
    {
        public readonly bool State;
        public readonly long MinX, MaxX, MinY, MaxY, MinZ, MaxZ;
        public CuboidLegacy(string input)
        {
    ...
    public  class ReactorLegacy : Array3D<bool>
    {
        public ReactorLegacy() : base(false) { }
